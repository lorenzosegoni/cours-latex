\chapter{Bases de Données (BD) et SGBD}

\section{Introduction : La problématique des fichiers}
...
\subsection{Limite des systèmes de gestion de fichiers}
...
\section{Objectifs d'une approche Base de Données}
...
\subsection{Le Contrôle de l'intégrité}
...
\subsection{La Sécurité de fonctionnement}
...
\chapter{Le Modèle Conceptuel de Données (E/A)}

Le modèle Entité / Association

\section{Le Principe du Modèle E/A}
...
\subsection{Les Attributs (Les détails)}
...
\subsection{L'Identifiant (La clé)}
...
\section{Les Associations (Les liens)}
...
\subsection{Les Cardinalités (La règle du jeu)}
...
\subsection{ Comprendre le (min, max)}
...
\subsection{ Les 3 grands types de relations }
...
\section{ Concepts Complémentaires }
...
\subsection{Contraintes d'Intégrité (CI)}
...
\section{ Formalisation et Documentation }
...
\subsection{ La Description des Objets (Entités et Associations) }
...
\subsection{ Description d'une Association}
...
\subsection{ Les Contraintes d'Intégrité (CI) }

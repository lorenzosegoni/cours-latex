...
\begin{enonce}
Soit $f(x)=x^2$.
\ques On veut montrer la croissance sur $[0,+\infty[$.

\ssques Calculer la dérivé de $f(x)$

\ssques En deduire que que $f(x)=x^2$ est croissante sur $[0,+\infty[$.
\end{enonce}
...
\ssques Puisque $f'(x)=2x \ge 0$ sur $[0,+\infty[$, donc $f$ est croissante.

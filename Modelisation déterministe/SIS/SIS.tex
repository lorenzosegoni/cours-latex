...
\smallskip
\noindent\textit{Séparation des variables.} L'équation se réécrit :

\[ \frac{dI}{I(K - I)} = \lambda \, dt \]

\smallskip
\noindent\textit{Décomposition en éléments simples.} Pour intégrer le membre de gauche, décomposons en éléments simples :
...
\smallskip
\noindent\textit{Intégration.} En intégrant des deux côtés :
...
\smallskip
\noindent\textit{Résolution pour $I(t)$.} En résolvant pour $I$ :
...
\smallskip
\noindent\textit{Détermination de la constante $C$.} À $t = 0$ :
...
\smallskip
\noindent\textit{Expression finale.} En substituant $C$ et $K = \frac{\lambda N - \gamma}{\lambda}$ :
...
\smallskip
\noindent\textit{Changement de variable.} Posons $Y(t) = \frac{1}{I(t)}$, qui est bien défini car $I(t) > 0$ pour tout $t \geq 0$.
...
\smallskip
\noindent\textit{Détermination de la constante.} À $t = 0$ :
...
\smallskip
\noindent\textit{Expression de $I(t)$.} En revenant à $I(t) = \frac{1}{Y(t)}$ :

...
\bigskip
\noindent\textbf{Cas 1 : $S_0 < \rho$ (régime sous-critique)}
...
\bigskip
\noindent\textbf{Cas 2 : $S_0 > \rho$ (régime épidémique)}
...
\bigskip
\noindent\textbf{Étape 1 : Condition de Cauchy}
...
\bigskip
\noindent\textbf{Étape 2 : Application du théorème des accroissements finis}
...
\bigskip
\noindent\textbf{Étape 3 : Passage à la limite}
...
\bigskip
\noindent\textbf{Étape 4 : Généralisation aux autres composantes}
...
\newpage
\noindent\textbf{Interprétation du portrait de phase}
...
\bigskip
\noindent\textbf{Dynamique de la propagation épidémique}
...
\bigskip
\noindent\textbf{Étape 1 : $\varphi$ est bien définie et à valeurs dans $[0, s_0]$}
...
\bigskip
\noindent\textbf{Étape 2 : Existence d'un point fixe}
...
\bigskip
\noindent\textbf{Étape 3 : Unicité du point fixe}
...
\bigskip
\noindent\textbf{Étape 4 : Méthode des approximations successives}
...
\begin{prop}\label{ordre_1_probleme}
...
\begin{prop}[Seuil d'immunité collective]
...
\bigskip
\noindent\textbf{Implications pratiques}
...
\bigskip
\noindent\textbf{Valeurs du nombre de reproduction de base pour différentes maladies}
